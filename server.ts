  ...
  app.post('/api/chat', async (req, res) => {
    try {
      ...
      if (!apiKey || apiKey === 'your_gemini_api_key_here') {
        ...
        } else if (text.includes('how this system works') || text.includes('how it works') || text.includes('how the system works') || text.includes('how does this work') || text.includes('show me how the app works') || text.includes('how the app works')) {
